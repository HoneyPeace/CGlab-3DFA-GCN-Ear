...
$RunTag = "mainpaconv_original_xyz3_latent1344_mds_seed1_lm069fix"
$ExpName = "S2G_MainPAConv_OriginalXYZ3_Latent1344_MDS_Seed1_LM069Fix"
$Stamp = Get-Date -Format "yyyyMMdd_HHmmss"
$PidPath = Join-Path $DebugDir "original_paconv_lm069fix_seed1.pid"
$StatusPath = Join-Path $DebugDir "original_paconv_lm069fix_seed1.status.tsv"
...
"$(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')`tqueue`t$RunTag`tSTART`tOriginal PAConv after train 069 landmark/heatmap patch" | Out-File -LiteralPath $StatusPath -Append -Encoding UTF8
