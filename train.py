...
def train(args):
    ...
    loss_controller.coord_term_weight = getattr(args, 'coord_term_weight', 1.0)
    loss_controller.surface_term_weight = getattr(args, 'surface_term_weight', 1.0)
    loss_controller.struct_term_weight = getattr(args, 'struct_term_weight', 1.0)
